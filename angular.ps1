# Criar arquivo 'angular.ps1' no mesmo diretório
# Executar no PowerShell com:
...
# Instala PrimeNG, PrimeIcons e PrimeFlex
Write-Host "Instalando PrimeNG, PrimeIcons e PrimeFlex..." -ForegroundColor Cyan
npm install primeng primeicons primeflex
Write-Host "Instalação de PrimeNG, PrimeIcons e PrimeFlex concluída." -ForegroundColor Green
